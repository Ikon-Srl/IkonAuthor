...
namespace Ikon.IKCMS.ExtraDB
{
  ...
  public partial class DataContext
  {
    ...
    public const string ContextStringDB = "Ikon.IKCMS.ExtraDB.DB";
    ...
    public static DataContext Factory(Ikon.GD.FS_Operations fsOp) { return new DataContext(fsOp.DB.Connection); }
