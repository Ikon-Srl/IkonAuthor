...
$(document).ready(function() {
  ...
  //
  $(document).on('change', '.autoSubmitDDL,.autoSubmitCB,.autoSubmitTB', function() { if ($.browser.msie) { $('iframe').remove(); } $(this).closest('form').submit(); });  // risolve i problemi con IE <= 7 e presenza di iframe con src su domini esterni
  //
  ...
  $(document).on('mouseenter', 'a.append_UrlBack:not(.clickableBlockLink)', function(e) { $(this).addClass('hover'); });
  $(document).on('mouseleave', 'a.append_UrlBack:not(.clickableBlockLink)', function(e) { $(this).removeClass('hover'); });
  //
  $(document).on('click', 'a.append_UrlBack:not(.clickableBlockLink)', function(e) {
    try {
      e.preventDefault();
  ...
  //
  $(document).on('submit click change', '.formSubmitWithAjaxLoad', function(e) {
    //
    var containerSelector = '.ajaxLoadContainer';
    var container = $(this).closest(containerSelector);
