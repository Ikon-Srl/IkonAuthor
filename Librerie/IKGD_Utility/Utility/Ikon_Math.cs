...
namespace Ikon.MathExt
{
  ...
  public static class RandomExtensions
  {
    ...
    /// <returns></returns>
    public static double NextGaussian(this Random r) { return NextGaussian(r, 0, 1); }
    public static double NextGaussian(this Random r, double mu, double sigma)
    {
      var u1 = r.NextDouble();
      var u2 = r.NextDouble();
